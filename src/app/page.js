...
import solanaimage1 from "../app/images/solanaimage1.png";
import solanaimage2 from "../app/images/solanaimage2.png";
      ...
      <div className="banner">
        <div className="banner-back ">
          <div className="banner-back-img">
            <Image src={solanaimage2} alt="/solanaimage2" />
          </div>
          <div className="banner-back-img2">
            <Image src={solanaimage1} alt="/solanaimage1" />
          </div>
        </div>
